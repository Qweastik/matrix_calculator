...
namespace matrix_calculator
{
        ...
        private void plus_Click(object sender, EventArgs e)
        {
            try
            {
                if (sizeA.Text == sizeB.Text)
                {
                    ...
                    MessageBox.Show("Складывать можно только матрицы одинакового размера", "Ошибка!");
            }
            catch (Exception)
            {
        ...
        private void minus_Click(object sender, EventArgs e)
        {
            try
            {
                if (sizeA.Text == sizeB.Text)
                {
                    ...
                    MessageBox.Show("Вычитать можно только матрицы одинакового размера", "Ошибка!");
            }
            catch (Exception)
            {
        ...
        private void multiply_Click(object sender, EventArgs e)
        {
            try
            {
                if (sizeA.Text == sizeB.Text)
                {
                    ...
                    MessageBox.Show("Умножать можно только матрицы одинакового размера", "Ошибка!");
            }
            catch (Exception)
            {
                MessageBox.Show("Непредвиденная ошибка", "Ошибка!");
        ...
        //нахождение минимального элемента матрицы B
            ...
            try
            {
                ...
                for (int i = 0; i < n; i++)
                {
                    for (int j = 0; j < n; j++)
                    {
                        ...
                        z += b[i, j] * Convert.ToInt32(numberB.Text);
                        omatrix[j, i].Value = z;
                    }
